...
|-------|------------------|------------|------------|------|
| 1 | 2.1 スパム対応対象の拡大 | — | `SpamCommentable`→`SpamMarkable` リネーム＋`spam_author` 多態化、Card::Usage / Card::Annotation / Tag、Admin コントローラ・ビュー・一括処理 | **ChangeSpec 作成済み**: [spam-target-expansion.md](../change-specs/spam-target-expansion.md) |
