...
#### 例外ユーザー
なし。リードオンリーモード中は、システム管理者を含む全てのユーザーが制限対象の操作を行えない。
...
- [ ] リードオンリーモード中、全てのユーザーが新規プロジェクトを作成できないこと
- [ ] リードオンリーモード中、全てのユーザーが既存プロジェクトを更新できないこと
- [ ] リードオンリーモード中、全てのユーザーがプロジェクト内カード（State、Annotation、NoteCard、Usage）の作成・更新・削除ができないこと
- [ ] リードオンリーモード中、全てのユーザーがコメントの投稿・削除ができないこと
- [ ] 自動解除日時を設定した場合、指定日時に自動でモードが解除されること
- [ ] リードオンリーモード中、サイト上部にバナーが全ユーザーに表示されること
- [ ] リードオンリーモード中、制限対象の操作を試みた際にエラーメッセージが表示されること
...
| 1.2 | 2026/01/11 | リードオンリーモードの制限対象を拡大：プロジェクト更新、State、Annotation、NoteCard、Usageを追加。例外ユーザーを廃止（全ユーザーが制限対象） |
